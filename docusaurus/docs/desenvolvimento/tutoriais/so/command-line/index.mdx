...
import Video from "./assets/dev-tutorials-command-line/terminal-emulator-konsole-with-bash.mp4";
export const introVideo = {
  title:
    "Por meio do comando 'echo', é retornado à saída textual o mesmo conteúdo que foi fornecido como argumento. Captura de Tela do Emulador de Terminal Konsole com o interpretador de shell GNU bash no sistema operacional GNU/Linux Manjaro.",
};
...
<video
  ...
  muted
  autoplay
  style={{ width: "100%", aspectRatio: "53/28" }}
>
...
<TabItem label="Windows" value="Windows" icon="seti:windows">
...
Por muito tempo, ao utilizar o CMD ou o PowerShell, não era comum a separação entre a ideia de Emulador de Terminal e a de Interpretador de Comandos.
...
<TabItem label="GNU/Linux" value="GNU/Linux" icon="linux">
...
- Yakuake.
  ...
  <TabItem label="macOS" value="macOS" icon="apple">

O macOS inclui o aplicativo **Terminal** por padrão, localizado em `Aplicativos > Utilitários > Terminal`. Ele funciona como emulador de terminal e já vem pronto para uso.

Além do Terminal nativo, existem alternativas populares:

- **iTerm2** — emulador de terminal com recursos avançados como divisão de painéis, busca e perfis personalizáveis;
- **Alacritty** — emulador leve e de alto desempenho, baseado em GPU;
- **Kitty** — emulador rápido com suporte a imagens e ligaduras tipográficas.
...
linhas de comandos pode ser considerada como a de ser um intermediário entre o usuário e o sistema operacional.
:::
...
- **Bash** (Bourne Again Shell) — o shell padrão na maioria das distribuições;
- **Zsh** — shell avançado com autocompletar e temas (padrão em algumas distros como Manjaro);
- **Fish** — shell com destaque de sintaxe e sugestões automáticas.

</TabItem>

<TabItem label="macOS" value="macOS" icon="apple">

- **Zsh** — shell padrão do macOS desde o Catalina (10.15);
- **Bash** — disponível como alternativa, mas em versão mais antiga (GPLv2).
...
- [https://www.hanselman.com/blog/whats-the-difference-between-a-console-a-terminal-and-a-shell](https://www.hanselman.com/blog/whats-the-difference-between-a-console-a-terminal-and-a-shell)
- [https://en.wikipedia.org/wiki/Comparison_of_command_shells](https://en.wikipedia.org/wiki/Comparison_of_command_shells)
- [https://pt.wikipedia.org/wiki/PowerShell](https://pt.wikipedia.org/wiki/PowerShell)
- [https://en.wikipedia.org/wiki/Command-line_interface](https://en.wikipedia.org/wiki/Command-line_interface)
- [https://pt.wikipedia.org/wiki/Cmd.exe](https://pt.wikipedia.org/wiki/Cmd.exe)
- [https://en.wikipedia.org/wiki/COMMAND.COM](https://en.wikipedia.org/wiki/COMMAND.COM)
