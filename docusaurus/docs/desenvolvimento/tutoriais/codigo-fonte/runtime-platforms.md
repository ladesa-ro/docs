...
2 - O arquivo deve possuir a [permissão](../so/file-permissions/index.md) de execução.
...
Dessa forma, o artefato final fica muito mais leve e requer menos recursos do que quando executado em um [Ambiente de Desenvolvimento](../ambientes.md).
