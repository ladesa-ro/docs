...
- **[Contrato do Solver (TypeSpec)](../specs/contrato-solver.md)** — schema de request e response
- **[Constraints do Solver](../specs/constraints-solver.md)** — 10 constraints + sistema de scoring
