...
import SourceApiClient from "!!raw-loader!./.parts-vue-nuxt/snippets/code-example-composable.ts";
import SourceCursoCreateVue from "!!raw-loader!./.parts-vue-nuxt/snippets/code-example-create-curso.vue";
...
![Documentação da classe LadesaApiClient](./.parts-vue-nuxt/doc-classe-api-client-fetch.png)
...
![Documentação Swagger da API](./.parts-vue-nuxt/doc-api-swagger.png)
