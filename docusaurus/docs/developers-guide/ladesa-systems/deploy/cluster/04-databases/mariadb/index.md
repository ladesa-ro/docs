...
[https://github.com/mariadb-operator/mariadb-operator/blob/main/docs/HELM.md#deployment-modes](https://github.com/mariadb-operator/mariadb-operator/blob/main/docs/HELM.md#deployment-modes)
