...
import imgOverview from "./web-api/_parts/assets/api-overview.drawio.png";
...
> Continue lendo em nossa [seção dedicada a _Web API Integrada_](./web-api/overview.mdx).
