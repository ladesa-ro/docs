...
<Tabs syncKey="operatingSystem">
  <TabItem label="Windows" icon="seti:windows">
    ...
    O sistema operacional _Windows_ conta com o _Prompt de Comandos_ (CMD) e o _PowerShell_ disponíveis por padrão nas versões mais recentes dessa plataforma. Há também o software _Windows Terminal_, criado pela Microsoft, que desempenha o papel de _emulador de terminal_.
    ...
    > TODO: inserir foto do Windows Terminal + Prompt de Comandos

    ---

    Por muito tempo, ao utilizar o CMD e o PowerShell não era comum a separação entre Emulador de Terminal e o Intepretador de Comandos.
    ...
    Apesar disso, ecossistema Windows caminha para a utilização do _Windows Terminal_ como Emulador de Terminal e o _Power Shell_ foca na competência de ser um interpretador de comandos.

    #### Projetos conhecidos para linha de comando no Windows

    | Nome               | Janela visual                                | Interpreta de comandos  | Vem instalado por padrão? |
    |------------------- | -------------------------------------------- | ----------------------- | - |
...
<Tabs syncKey="operatingSystem">
  <TabItem label="Windows" icon="seti:windows">
    Por muito tempo, o _CMD_ — também conhecido como _Prompt de Comando do Windows_ —, esteve presente junto ao _Power
    Shell_ nos sistemas operacionais _Windows / NT_. Os dois projetos forneceram por muito tempo tanto um emulador de
    terminal quanto o interpretador de shell. Atualmente, projeto _Power Shell_ — que conta com muitos novos recursos,
    atualizações e otimizações —, caminha para desepenhar cada vez mais o papel apenas de shell — sendo esse o
    recomendado para a utilização em ambientes _Windows_. Assim, o trabalho de projetar a janela visual fica a cargo do
    _Windows Terminal_.
  </TabItem>
